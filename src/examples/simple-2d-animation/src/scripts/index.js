...
var three_plain_animator_1 = require("three-plain-animator");
var camera;
var renderer;
var animator;
function initScene() {
    ...
    camera = new three_1.OrthographicCamera((frustumSize * aspect) / -2, (frustumSize * aspect) / 2, frustumSize / 2, frustumSize / -2, 1, 2000);
    renderer = new three_1.WebGLRenderer();
    renderer.setSize(window.innerWidth, window.innerHeight);
    document.body.appendChild(renderer.domElement);
    scene.background = new three_1.Color('#1976D2');
...
function createAnimatedMesh() {
    ...
    animator = new three_plain_animator_1.PlainAnimator(new three_1.TextureLoader().load(texturePath), 4, 4, 10, 10);
